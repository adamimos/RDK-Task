...
test = ForcedChoice2(box.com_port,[2*cals{1} 150 2*cals{2}]); % 20 uL dose
...
min_time_vis = 0.9;%0.1; % seconds of minimum time the stimulus is visible
...
coherence_type = 'one value';%'testing';%'training';% % 'training';%''training';%'training';%%'testing';%
