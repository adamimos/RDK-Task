...
min_time_vis = .7;%0.1; % seconds of minimum time the stimulus is visible
...
coherence_type = 'one value';%'testing';%'difficult';%'training';%% % 'training';%''training';%'training';%%'testing';%
