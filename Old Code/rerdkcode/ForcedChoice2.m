...
classdef ForcedChoice2 < handle
    ...
    methods
        function choice = ForcedChoice2(comPort)
            ...
            p.corridor(1).dose = 45; %shai changed from 49 to 0
            p.corridor(1).dose_duration = 200; % 40 
            p.corridor(1).lick = 25; %shai changed from 47 to 1
            ...
            p.corridor(2).dose = 30;
            p.corridor(2).dose_duration = 200; % ms
            p.corridor(2).lick = 41;
            ...
            p.corridor(3).dose = 48;
            p.corridor(3).dose_duration = 200; % ms
            p.corridor(3).lick = 37;
