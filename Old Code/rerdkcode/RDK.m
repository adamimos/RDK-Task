...
%% PARAMETERS
params.nTrials = 100; % number of trials
...
dots.lifetime = 30;  %lifetime of each dot (frames)

display.dist = 10.2;  %cm
display.width = 50.8; %cm
display.frameRate = 59;
display.screenNum = 2;
...
for trial = 1:params.nTrials
    ...
    while didPokeCenter == 0
        ...
        if test.is_licking(2)
            ...
            while test.is_licking(2) || (GetSecs-timeCenterPoke) < 1.5;         
                %% show stim
