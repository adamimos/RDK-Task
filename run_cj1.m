...
stim_response_type = 'grow nose in center infinite';%'grow nose in center infinite';%'infinite play forgiveness';%'sound forgiveness';%
priors_type = 'blocks';% 'random';%'random'
coherence_type = 'one value';%'testing';%'testing';%
