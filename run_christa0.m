...
stim_response_type = 'grow nose in center';%finite center';%'grow nose in center infinite';%'finite center';%'grow nose in center infinite';%'infinite play forgiveness';%'sound forgiveness';%%'grow nose in center';%
priors_type = 'blocks';% 'random';%'random'
coherence_type = 'testing';%'one value';%'testing';%
