classdef arduino < handle
    ...
    methods
        ...
        % THK
        function send_pulse(a, pin, duration_ms)
            % send mode, target pin, duration
            fwrite(a.aser,[89, pin, duration_ms], 'uchar');
            
            %val=fscanf(a.aser, '%d')
        end % send_pulse
        
        function set_pin(a,pin,value)
           fwrite(a.aser,[64,pin,value],'uchar');
           
        end
        
        function set_rotary(a)
            fwrite(a.aser, [75 0], 'uchar');
        end
        
        function play_tones(a, pin, duration)
           fwrite(a.aser, [69 pin duration] , 'uchar'); 
        end
        
        
        
        function rotate_stepper(a, step_pin, dir, num_90degs)
            % send mode, stepper pin, direction, number of 90 deg rotations
            fwrite(a.aser, [88, step_pin, dir, num_90degs], 'uchar');
        ...
        % round trip
        function val=roundTrip2(a,lick_port)
