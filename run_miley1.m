...
coherence_type = 'testing';%'one value';%'training';%'one value';%'testing';%
...
% timeout = 0.0; % seconds of timeout for incorrect response
% 
% stim_response_type = 'grow nose in center';%'finite center';%'grow nose in center';%'infinite play forgiveness';%
